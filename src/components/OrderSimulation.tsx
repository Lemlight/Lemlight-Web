              ...
              return (
                <div key={stage.id} className="flex flex-col items-center">
                  ...
                  <motion.div
                    ...
                    className={`w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center transition-all duration-300 mb-3 relative z-10 ${isCompleted || isActive
...
>
                  ...
                  <div className="text-center">
                    <p
                      className={`text-xs md:text-sm font-medium transition-colors ${isCompleted || isActive ? "text-[#fbcb32]" : "text-white/60"
                        }`}
                    >
                      {stage.status}
                    </p>
